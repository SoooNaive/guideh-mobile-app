...
class CheckupHouseStepBuildingOtherEngineeringEquipment extends StatefulWidget {
  final StepData step;
  final CheckupHouseCaseObject caseObject;
  const CheckupHouseStepBuildingOtherEngineeringEquipment(this.step, this.caseObject, {super.key});

  @override
  State<CheckupHouseStepBuildingOtherEngineeringEquipment> createState() => _CheckupHouseStepBuildingOtherEngineeringEquipmentState();
}

class _CheckupHouseStepBuildingOtherEngineeringEquipmentState extends State<CheckupHouseStepBuildingOtherEngineeringEquipment> {
    ...
    final stepContent = CheckupHouseStepContent(
      ...
      content: Column(
        ...
        children: [
          ...
          RichText(
            text: const TextSpan(
              text: 'Прочее инженерное оборудование в доме – ',
          ...
          ClipRRect(
            ...
            child: Image.asset('assets/images/checkup_house/step_otherEngineeringEquipment_01.jpg'),
          ),
          const SizedBox(height: 15),
          ClipRRect(
            borderRadius: BorderRadius.circular(borderRadiusBig),
            child: Image.asset('assets/images/checkup_house/step_otherEngineeringEquipment_02.jpg'),
          ),
          const SizedBox(height: 15),

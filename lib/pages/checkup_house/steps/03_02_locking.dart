...
class CheckupHouseStepBuildingLocking extends StatefulWidget {
  final StepData step;
  final CheckupHouseCaseObject caseObject;
  const CheckupHouseStepBuildingLocking(this.step, this.caseObject, {super.key});

  @override
  State<CheckupHouseStepBuildingLocking> createState() => _CheckupHouseStepBuildingLockingState();
}

class _CheckupHouseStepBuildingLockingState extends State<CheckupHouseStepBuildingLocking> {
    ...
    final stepContent = CheckupHouseStepContent(
      ...
      content: Column(
        ...
        children: [
          ...
          const Text(
            'Сфотографируйте все входные двери и всю защиту окон (рольставни, мет. решётки и пр.). Минимум по одной фотографии.',
            style: TextStyle(fontSize: 16, height: 1.25),
          ),
          const SizedBox(height: 15),
          ClipRRect(
            borderRadius: BorderRadius.circular(borderRadiusBig),
            child: Image.asset('assets/images/checkup_house/step_locking_01.jpg'),
          ),
          const SizedBox(height: 15),
